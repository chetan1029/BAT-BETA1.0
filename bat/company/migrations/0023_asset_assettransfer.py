# Generated by Django 3.1.1 on 2020-12-17 11:42
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('company', '0022_merge_20201217_0852'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset_id', models.CharField(max_length=200, verbose_name='Unique ID for Asset')),
                ('title', models.CharField(max_length=200, verbose_name='Asset Title')),
                ('type', models.CharField(blank=True, max_length=200, verbose_name='Asset Type')),
                ...
                ('price', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='USD', max_digits=14, verbose_name='Asset Price')),
                ('date', models.DateTimeField()),
                ('receipt', models.FileField(blank=True, upload_to=bat.company.models.asset_file_name, verbose_name='Receipt')),
                ...
                ('current_location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='company.location')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_date', models.DateTimeField(default=django.utils.timezone.now)),
                ('update_date', models.DateTimeField(default=django.utils.timezone.now)),
                ('asset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='company.asset')),
                ('from_location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='asset_from_location', to='company.location')),
                ('to_location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='asset_to_location', to='company.location')),
            ],
            options={
                'verbose_name_plural': 'Asset Trasnfers',
            },
        ),
    ]
