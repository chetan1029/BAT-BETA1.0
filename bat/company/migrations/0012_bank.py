...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('company', '0011_remove_companypaymentterms_user'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('benificary', models.CharField(max_length=100, verbose_name='Benificary Name')),
